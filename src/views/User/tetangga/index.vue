      ...
      <div class="col-12">
        <div class="mb-4 card">
          ...
          <div class="px-0 pt-0 pb-2 card-body">
            ...
            <h6 v-else-if="wadah.length == 0" class="text-center">Tidak Menyewa Kamar</h6>
              ...
              <table class="table mb-0 align-items-center text-center">
                <thead>
                  <tr>
                    ...
                    <th class=" text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Religion</th>
                    <th class=" text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Gender</th>
                    <th class=" text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kamar</th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(item, key) in wadah" :key="key">
                    ...
                    <td>
                      <p class="mb-0 text-xs font-weight-bold">{{ item.username }}</p>
                    </td>
                    <td>
                      <p class="mb-0 text-xs font-weight-bold">{{ item.gender }}</p>
                    </td>
                    <td>
                      <p class="mb-0 text-xs font-weight-bold">{{ item.religion }}</p>
                    </td>
                    <td>
                      <p class="mb-0 text-xs font-weight-bold">{{ item.room }}</p>
                    </td>
                  </tr>
                </tbody>
              </table>
