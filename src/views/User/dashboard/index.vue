<template>
  ...
  <div class="py-4 container-fluid">
    <div v-if="!user.verify_email"><h3 class="py-4 text-center card text-primary">Harap Lakukan Verifikasi Email</h3></div>
    <div v-else class="mt-3 row">
      <div class="mt-4 col-12 col-md-7 col-xl-7 mt-md-0">
        <div class="card h-100">
          ...
          <h6 v-else-if="history == undefined" class="text-center">
            Tidak Menyewa Kamar
          </h6>
          <div v-else class="px-4 py-0 card-body">
            <ul class="list-group">
              <li class="text-sm border-0 list-group-item ps-0">
                <strong class="text-dark">Durasi:</strong> &nbsp;
                {{ history.duration }} Bulan
              </li>
              <li class="text-sm border-0 list-group-item ps-0">
              ...
              <li class="text-sm border-0 list-group-item ps-0">
                <strong class="text-dark">Bangunan:</strong> &nbsp;
                {{ history.build_name }}
              </li>
              <li class="text-sm border-0 list-group-item ps-0">
                <strong class="text-dark">Ruangan:</strong> &nbsp;
                {{ history.room_name }}
              </li>
              <li class="text-sm border-0 list-group-item ps-0">
      ...
      <div class="mt-4 col-12 col-md-5 col-xl-5 mt-md-0">
        <div class="card h-100">
          ...
          <div class="px-0 pt-0 pb-2 card-body">
            ...
            <h6 v-else-if="tetangga.length == 0" class="text-center">
      ...
      if (history.length == 0) {
        ...
        vm.payment = (
          await axios.get("/payment/show-payment", {
            params: { history_id: history.history_id },
          })
        ...
        tetangga.length == 0
          ? (vm.tetangga = undefined)
          : (vm.tetangga = tetangga.data.data);
      }
    } catch (err) {
      console.log("error");
      console.log(err);
